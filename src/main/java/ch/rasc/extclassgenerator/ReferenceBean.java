...
public class ReferenceBean {
	...
	public boolean hasAnyProperties() {
		return Util.hasText(this.type) || Util.hasText(this.association)
				|| Util.hasText(this.child) || Util.hasText(this.parent)
				|| Util.hasText(this.role) || Util.hasText(this.inverse);
	}
